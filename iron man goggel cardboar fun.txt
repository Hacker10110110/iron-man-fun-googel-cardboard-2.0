...
/// <summary>
/// Iron Man VR Prototype for Google Cardboard
/// Drop this single script into Unity, attach components as needed.
/// </summary>
public class VRIronManController : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (thrust)
        {
            ...
            rb.AddForce(forward * thrustForce, ForceMode.Acceleration);
        }
